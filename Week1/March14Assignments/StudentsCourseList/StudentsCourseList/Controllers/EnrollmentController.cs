...
using StudentsCourseList.Models;

namespace StudentsCourseList.Controllers
{
        ...
        public IActionResult Index()
        {
            var students = _students.Select(s => new StudentCoursesVM
            {
                ...
                CourseTitles = s.Enrollments
                    .Select(e => _courses
                        .FirstOrDefault(c => c.CourseId == e.CourseId)?.Title ?? "")
                    .ToList()
            }).ToList();
...
//https://localhost:7273/Enrollment/Details?studentId=5

//https://localhost:7273/Enrollment